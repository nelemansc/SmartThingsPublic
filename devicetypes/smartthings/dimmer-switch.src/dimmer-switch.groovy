...
metadata {
	...
	tiles(scale: 2) {
		multiAttributeTile(name:"rich-lighting-control", type: "lighting", width: 6, height: 4, canChangeIcon: true){
		...
		main(["rich-lighting-control"])
		details(["rich-lighting-control", "refresh", "indicator"])
	}
}
